...
<div class="flex flex-1 !p-6 !px-2.5 items-center flex-col -mb-4">
    <div class="max-w-[775px] w-full">
        ...
        <!-- Forum Topics Table -->
        <div class="bg-white dark:!bg-[var(--main-white)] rounded-lg long-shadow overflow-hidden">
            <table class="min-w-full">
                <thead class="bg-gray-100 dark:!bg-neutral-600">
                    <tr>
                        <th class="!p-3 text-left text-xs font-medium uppercase tracking-wider">Tiêu
                            đề</th>
                        <th
                            class="!p-3 text-center text-xs font-medium uppercase tracking-wider hidden sm:table-cell min-w-[75px]">
                            Trả
                            lời</th>
                        <th class="!p-3 text-center text-xs font-medium uppercase tracking-wider hidden sm:table-cell">
                            Xem
                        </th>
                        <th
                            class="sm:!p-3 pr-3 text-right text-xs font-medium uppercase tracking-wider min-w-[115px] max-w-[200px]">
                            Bài
                            viết cuối</th>
                    </tr>
                </thead>
                                    ...
                                    <div class="flex gap-y-2 flex-col flex-1">
                                        <div class="text-sm font-medium">
                                            <a href="/{{ $post->username }}/posts/{{ $post->post_id }}"
                                                class="text-green-600 hover:text-green-800 dark:hover:text-green-500">{{ $post->title }}</a>
                                        </div>
