...
@section('content')
    ...
    <div class="flex flex-1 !p-6 !px-2.5 items-center flex-col -mb-8">
        @foreach ($mainCategories as $mainCategory)
            ...
            <div class="max-w-[775px] w-[100%] mb-6">
                ...
                <div class="bg-white dark:!bg-[var(--main-white)] long-shadow rounded-lg mt-2">
    ...
    <div class="px-2.5 relative z-10 mb-4 mt-2">
        {{-- Forum stats --}}
        <div class="max-w-[775px] mx-auto bg-white dark:!bg-[var(--main-white)] p-6 rounded-lg long-shadow">
            <div class="flex flex-row items-center justify-between mb-4">
                <h2 class="text-lg font-semibold uppercase">Thống kê diễn đàn</h2>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div
                    class="bg-[#E7FFE4] dark:!bg-[#2b2d2c] dark:hover:!bg-[#4a4a4a] hover:bg-green-100 shadow-md rounded-lg p-4 text-center">
            ...
            <div class="mt-6">
                ...
                <p class="text-gray-600 my-2 dark:!text-gray-50">
                    Tổng cộng có
