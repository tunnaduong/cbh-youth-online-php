        ...
        <div class="row gap-3 gap-md-0">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-none mt-3 flex flex-col gap-2">
                    <li><a href="/forum/hoc-tap" class="text-[#6B6B6B] hover:text-[#319527]">Góc học tập</a></li>
                    <li><a href="/forum/hoat-dong-ngoai-khoa/cau-lac-bo" class="text-[#6B6B6B] hover:text-[#319527]">Câu
                            lạc bộ</a></li>
                    <li><a href="/forum/hoat-dong-ngoai-khoa" class="text-[#6B6B6B] hover:text-[#319527]">Hoạt động</a>
                    </li>
                    <li><a href="/forum/giai-tri-xa-hoi" class="text-[#6B6B6B] hover:text-[#319527]">Giải trí</a></li>
                    <li><a href="/forum/hoc-tap/ebook-giao-trinh" class="text-[#6B6B6B] hover:text-[#319527]">Tài liệu
                            ôn thi</a></li>
                </ul>
            </div>
            <div class="col-md-3">
                ...
                <ul class="list-none mt-3 flex flex-col gap-2">
                    <li><a href="/Admin/posts/213054" class="text-[#6B6B6B] hover:text-[#319527]">Nội quy diễn đàn</a>
                    </li>
                    <li><a href="/" class="text-[#6B6B6B] hover:text-[#319527]">Chính sách bảo mật</a></li>
                    <li><a href="/" class="text-[#6B6B6B] hover:text-[#319527]">Điều khoản sử dụng</a></li>
                </ul>
            </div>
            <div class="col-md-3">
                ...
                <ul class="list-none mt-3 flex flex-col gap-2">
                    <li>Email: <a href="mailto:cbhyouthonline@gmail.com"
                            class="text-[#6B6B6B] hover:text-[#319527]">cbhyouthonline@gmail.com</a></li>
                    <li>Hotline: <a href="tel:+84707006421" class="text-[#6B6B6B] hover:text-[#319527]">(+84) 7070 064
                            21</a></li>
                    <li>Fanpage: <a href="https://facebook.com/cbhyouthonline"
                            class="text-[#6B6B6B] hover:text-[#319527]">@CBHYouthOnline</a></li>
                </ul>
            </div>
        </div>
