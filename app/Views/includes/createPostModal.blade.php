    ...
    <div class="modal-content">
        <div>
            ...
            <div class="p-3 flex flex-row items-center">
                <img src="https://api.chuyenbienhoa.com/v1.0/users/{{ $_SESSION['user']->username }}/avatar"
                    alt="hoangphat's avatar" class="w-11 h-11 rounded-full">
            ...
            <form action="" method="POST" class="space-y-4 px-3 pb-3">
                <input id="postTitle"
                    ...
                    placeholder="Tiêu đề bài viết" type="text" value="">
                ...
                </div><button id="createPostButton"
