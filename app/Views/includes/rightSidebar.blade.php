...
<div class="hidden max-lg:block p-6 pt-0" id="bottom-sidebar">
    <div class="bg-white text-sm p-3 rounded-xl long-shadow">
        <span class="font-bold text-[#6B6B6B] block text-base">Top thành viên tháng</span>
        <div class="flex flex-row items-center mt-2">
            <span class="w-8 h-8 text-white bg-gray-300 rounded-full flex items-center justify-center">D</span>
            <span class="ml-1.5 font-semibold flex-1 truncate">Dương Tùng Anh</span>
    ...
    <div class="flex flex-row text-sm font-semibold p-3 text-[#BCBCBC]">
        <div class="flex flex-1 text-right flex-col gap-y-0.5">
            <a href="#">Hỗ trợ</a>
            <a href="#">Liên hệ</a>
            <a href="#">Blog</a>
            <a href="#">Quảng cáo</a>
