...
@section('content')
    <div class="flex flex-col items-center w-full flex-1 p-2 pt-3">
        <div data-post-id="213012" class="w-full mb-5 shadow-lg rounded-lg !p-4 bg-white flex flex-row md:max-w-[679px]">
            <div class="min-w-[84px] items-center mt-1 flex-col flex ml-[-15px] text-[13px] font-semibold text-gray-400">
                ...
                <div
                    ...
                    <ion-icon name="bookmark" class="text-[#CACACA] text-xl"></ion-icon>
                </div>
            </div>
            <div class="flex-1 overflow-hidden break-words"><a href="/tunnaduong/posts/213012">
                ...
                <div class="flex-row flex text-[13px] items-center"><a href="/tunnaduong"><span
                    ...
                    <a class="ml-1.5 md:ml-0.5 text-[#319527] hover:text-[#319527] font-bold" href="/tunnaduong">Tùng A
                        Dính</a>
