...
@section('content')
    ...
    <div class="container-main mt-14 px-3">
        ...
        <form action="/help/search" method="GET">
            <input type="text" name="query" class="w-[100%] p-3 mt-3 rounded-xl border-[#ECECEC] text-base"
                placeholder="Tìm kiếm bài viết trợ giúp...">
        </form>
        <h2 class="text-[20px] font-semibold !mt-10 mb-3">Chủ đề phổ biến</h2>
        <div class="flex items-center justify-between gap-x-3">
            <a href="/help/1" class="flex-1 flex flex-col justify-center bg-[#eaebec] rounded-lg p-3 hover:bg-[#e1e2e3]">
                ...
                <div class="mt-4">
                    ...
                    <p class="text-[12px] text-gray-500">Điều chỉnh cài đặt, quản lý thông báo, tìm hiểu về thay đổi tên và
                        các nội dung
                        khác.</p>
                </div>
            </a>
            <a href="/help/2" class="flex-1 flex flex-col justify-center bg-[#eaebec] rounded-lg p-3 hover:bg-[#e1e2e3]">
                <div class="flex items-center justify-center">
                ...
                <div class="mt-4">
                    ...
                    <p class="text-[12px] text-gray-500">Khắc phục sự cố khi đăng nhập và tìm hiểu cách thay đổi hoặc đặt
                        lại mật khẩu.</p>
                </div>
            </a>
            <a href="/help/3" class="flex-1 flex flex-col justify-center bg-[#eaebec] rounded-lg p-3 hover:bg-[#e1e2e3]">
                <div class="flex items-center justify-center">
                ...
                <div class="mt-4">
                    ...
                    <p class="text-[12px] text-gray-500">Kiểm soát đối tượng có thể nhìn thấy nội dung bạn chia sẻ và gia
