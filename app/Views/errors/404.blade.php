...
@section('content')
    <div class="flex flex-1 items-center justify-center" id="error-404"
        ...
        <center><img src="/assets/images/404.svg" alt="404" class="w-[80px] h-[80px] mb-2">
            ...
            <p class="text-[12px] text-gray-500 max-w-[350px]">Lỗi này thường do chủ sở hữu chỉ chia sẻ nội dung với một nhóm
                nhỏ,
                thay
